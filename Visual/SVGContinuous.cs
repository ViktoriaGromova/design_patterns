...
namespace Visual
{
    class SVGContinuous : ASVGDrawer
    {
        public override void DrawLastPoint(ICurve C)
        {
            ...
            content.Append("<circle cx=\"" + (int)end.X + "\" cy=\"" + (int)end.Y + "\" r=\"10\" fill=\"green\" /> \n");
        }
        ...
        public override void DrawSegment(ICurve C, double t1, double t2)
        {
            ...
            content.Append("<line x1=\"" + (int)start.X + "\" y1=\"" + (int)start.Y + "\" x2=\"" + (int)end.X + "\" y2=\"" + (int)end.Y + "\" stroke=\"green\" /> \n");
        }
